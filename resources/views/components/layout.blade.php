            ...
            @else
                <div class="flex items-center">
                    <div class="flex gap-4 items-center">
                        <a href="/dashboard" class="rounded-full border-2 border-white">
                    ...
                    <a href="/logout"
                       class="inline-block px-4 py-2 leading-none border rounded text-black border-white hover:border-transparent hover:text-green-500 hover:bg-white">Logout</a>
